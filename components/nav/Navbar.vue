<template>
	<nav class="nav top-0 fixed z-30 w-full flex flex-wrap items-center justify-between px-2 py-1">
		<div class="container pl-4 pr-0 md:px-10 mx-auto flex flex-wrap items-center justify-between max-w-screen-lg">
			<div class="w-full relative flex justify-between md:w-auto md:static md:block md:justify-start">
				<span class="nav-logo text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase">
					<slot name="title" />
				</span>
				<slot name="buttons" />
			</div>
