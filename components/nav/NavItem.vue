<template>
	<div
		class="nav-item block w-full px-4 py-3 md:py-0 flex items-center text-xs uppercase font-bold cursor-pointer"
...
<style scoped>
.disabled {
	@apply text-gray-800 md:hover:text-gray-800 cursor-default;
}
</style>